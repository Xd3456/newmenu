...
local Library = {
    ...
    Font = Enum.Font.SourceSans, -- Default: Enum.Font.Code
...
local function GetOtherPlayersString()
    ...
    for i = 1, #PlayerList do
        if PlayerList[i] ~= Players.LocalPlayer then
            FilteredPlayerList[#FilteredPlayerList + 1] = PlayerList[i].Name
        end
    end

    table.sort(FilteredPlayerList, function(str1, str2) return str1 < str2 end)
...
do
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        elseif Info.SpecialType == 'Team' then
            ...
            Info.AllowNull = true;
        elseif Info.SpecialType == 'OtherPlayer' then
